...
@interface CaseTableViewController_4()
...
@implementation CaseTableViewController_4
...
- (void)viewDidLoad {
    ...
    self.headerLabel.text = @"Strengthening trade and investment support institutions";
...
- (IBAction)backButtonTapped:(id)sender {
    ...
    CaseTableViewController_3 *nextVC =[self.storyboard instantiateViewControllerWithIdentifier:@"CVT3"];
...
- (IBAction)nextButtonTapped:(id)sender {
    ...
    CaseTableViewController_5 *nextViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"CVT5"];
